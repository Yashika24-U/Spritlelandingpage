          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h1 className="text-5xl  lg:text-6xl font-bold leading-tight text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500">
                ...
                <span className="text-5xl lg:text-6xl font-bold leading-tight text-white">
                  Proactive Network and IT Monitoring
                </span>
              </h1>
              <p className="text-xl text-gray-300 leading-relaxed">
                ManageEngine OpManager Plus empowers organizations to monitor
                networks, servers, and applications in real time, ensuring high
                availability, performance, and faster troubleshooting.
              </p>
            </div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                <span className="text-green-400 mt-1">✓</span>
                <span className="text-lg">
                  Simplified IT operations for improved performance
                </span>
              </li>
            </ul>
          ...
          <div className="bg-gray-900/80 backdrop-blur border border-gray-800 rounded-lg p-8 space-y-6">
            <div>
              <h3 className="text-2xl font-bold mb-2">
                Talk to an IT Monitoring Expert
              </h3>
              <p className="text-gray-400">
                Get expert guidance on implementing OpManager Plus to monitor
                your IT infrastructure, detect issues before they impact users,
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <div>
              <h2 className="text-4xl lg:text-5xl font-bold mb-6">
                What is ManageEngine OpManager Plus?
              </h2>
              <p className="text-xl text-gray-400 leading-relaxed">
                ManageEngine OpManager Plus is a unified IT monitoring platform
                that tracks networks, servers, applications, and cloud resources
                from a single console. It helps detect issues early, prevent
                downtime, and ensure smooth IT operations across hybrid
                environments.
              </p>
            </div>
            ...
            <div className="mt-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="space-y-4">
                  ...
                  <h4 className="text-xl font-semibold">
                    Proactive Performance & Fault Management
                  </h4>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <h4 className="text-xl font-semibold">
                    High Availability & Downtime Prevention
                  </h4>
                </div>
              </div>
            </div>
      ...
      >
        <div className="container mx-auto px-4">
          <h2 className="text-4xl lg:text-5xl font-bold text-center mb-16">
            Why Choose ManageEngine OpManager Plus?
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-8 hover:border-green-500 transition space-y-4">
              ...
              <p className="text-gray-400">
                Monitor networks, servers, applications, and cloud resources
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-8 hover:border-green-500 transition space-y-4">
              ...
              <p className="text-gray-400">
                Receive alerts and notifications before potential problems
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-8 hover:border-green-500 transition space-y-4">
              ...
              <p className="text-gray-400">
                Identify bottlenecks, optimize resource usage, and ensure high
                service uptime.
              </p>
            </div>
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-8 hover:border-green-500 transition space-y-4">
              ...
              <p className="text-gray-400">
                Centralized monitoring and automated reporting reduce manual
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-8 hover:border-green-500 transition space-y-4">
              ...
              <p className="text-gray-400">
                Gain deep insights with performance analytics and quickly
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-8 hover:border-green-500 transition space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-xl font-semibold">
                  Scalable & Hybrid Environment Support
                </h3>
              </div>
              <p className="text-gray-400">
                Easily monitor physical, virtual, and cloud infrastructures as
                your IT environment grows.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div>
                <h2 className="text-4xl lg:text-5xl font-bold mb-6">
                  OpManager Plus – Core Capabilities
                </h2>
              </div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-lg">
                    Network Performance Monitoring & Fault Management
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-green-400 font-bold">•</span>
                ...
                <li className="flex items-start gap-3">
                  <span className="text-green-400 font-bold">•</span>
                  <span className="text-lg">Cloud Resource Monitoring</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-green-400 font-bold">•</span>
                  <span className="text-lg">
                ...
                <li className="flex items-start gap-3">
                  <span className="text-green-400 font-bold">•</span>
                  <span className="text-lg">
                    Configuration & Bandwidth Monitoring
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-green-400 font-bold">•</span>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl lg:text-5xl font-bold text-center mb-12">
              Who Should Use ManageEngine OpManager Plus?
            </h2>
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-12 space-y-6">
              <div className="flex items-start gap-4">
                ...
                <p className="text-lg">
                  IT admins managing networks, servers, and applications
                </p>
              </div>
              <div className="flex items-start gap-4">
                <span className="text-green-400 text-2xl font-bold">✓</span>
                <p className="text-lg">
                  Enterprises seeking proactive IT monitoring and downtime
                  prevention
                </p>
              </div>
              <div className="flex items-start gap-4">
                <span className="text-green-400 text-2xl font-bold">✓</span>
                <p className="text-lg">
                  Organizations monitoring hybrid IT and cloud environments
                </p>
              </div>
              <div className="flex items-start gap-4">
                <span className="text-green-400 text-2xl font-bold">✓</span>
                <p className="text-lg">
                  Businesses looking to optimize performance and ensure uptime
                </p>
              </div>
              <div className="flex items-start gap-4">
                <span className="text-green-400 text-2xl font-bold">✓</span>
                <p className="text-lg">
                  Companies aiming to simplify IT monitoring and reporting
                </p>
              </div>
            </div>
          </div>
      ...
      >
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <div>
              <h2 className="text-4xl lg:text-5xl font-bold mb-6">
                Stay Ahead of IT Issues with OpManager Plus
              </h2>
              <p className="text-xl text-gray-400 leading-relaxed">
                Monitor your IT infrastructure, prevent downtime, and optimize
                performance with ManageEngine OpManager Plus. Get expert
                guidance to implement a scalable, efficient, and proactive IT
                monitoring strategy tailored to your organization.
              </p>
            </div>
