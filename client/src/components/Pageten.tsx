          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-gray-300 leading-relaxed">
                ManageEngine Log360 helps organizations collect, analyze, and
                monitor logs from servers, applications, network devices, and
                cloud platforms, enabling faster threat detection and compliance
                management.
              </p>
            </div>
          ...
          <div className="bg-gray-900/80 backdrop-blur border border-gray-800 rounded-lg p-8 space-y-6">
            <div>
              ...
              <p className="text-gray-400">
                Get expert guidance on implementing Log360 to monitor logs,
                detect threats, and maintain regulatory compliance with
                confidence.
              </p>
            </div>
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <div>
              ...
              <p className="text-xl text-gray-400 leading-relaxed">
                ManageEngine Log360 is an integrated SIEM and log management
                solution that collects and analyzes logs across on-prem, cloud,
                and network environments. It helps detect security threats
                early, ensure compliance, and gain actionable IT insights.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-8 hover:border-green-500 transition space-y-4">
              ...
              <p className="text-gray-400">
                Collect and store logs from all sources in a secure, searchable
                repository.
              </p>
            </div>
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-8 hover:border-green-500 transition space-y-4">
              ...
              <p className="text-gray-400">
                Identify security anomalies and potential threats as they
                happen.
              </p>
            </div>
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-8 hover:border-green-500 transition space-y-4">
              ...
              <p className="text-gray-400">
                Generate reports aligned with standards like GDPR, HIPAA, ISO,
                SOX, and PCI DSS.
              </p>
            </div>
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-8 hover:border-green-500 transition space-y-4">
              ...
              <p className="text-gray-400">
                Reduce manual monitoring with automated correlation, alerts, and
                dashboards.
              </p>
            </div>
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-8 hover:border-green-500 transition space-y-4">
              ...
              <p className="text-gray-400">
                Analyze attack patterns, investigate incidents faster, and
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-8 hover:border-green-500 transition space-y-4">
              ...
              <p className="text-gray-400">
                Easily scale log monitoring across on-prem, cloud, and hybrid
                infrastructures as your organization grows.
              </p>
            </div>
          </div>
            ...
            <div className="space-y-8">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-lg">Log Collection & Correlation</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-green-400 font-bold">•</span>
                  <span className="text-lg">
                ...
                <li className="flex items-start gap-3">
                  <span className="text-green-400 font-bold">•</span>
                  <span className="text-lg">SIEM and Threat Analytics</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-green-400 font-bold">•</span>
                  <span className="text-lg">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-12 space-y-6">
              <div className="flex items-start gap-4">
                ...
                <p className="text-lg">
                  IT security teams monitoring on-premises and cloud
                  environments
                </p>
              </div>
              <div className="flex items-start gap-4">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <div>
              ...
              <p className="text-xl text-gray-400 leading-relaxed">
                Detect threats, maintain compliance, and analyze IT logs
                effectively with ManageEngine Log360. Get expert guidance to
                implement a scalable, efficient, and security-focused SIEM and
                log management strategy tailored to your organization.
              </p>
            </div>
