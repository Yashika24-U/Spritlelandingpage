      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-gray-300 leading-relaxed">
                ManageEngine Log360 helps organizations collect, analyze, and monitor logs from servers, applications, network devices, and cloud platforms, enabling faster threat detection and compliance management.
          ...
          <div className="bg-gray-900/80 backdrop-blur border border-gray-800 rounded-lg p-8 space-y-6">
            <div>
              <h3 className="text-2xl font-bold mb-2">Talk to a Security Expert</h3>
              <p className="text-gray-400">
                Get expert guidance on implementing Log360 to monitor logs, detect threats, and maintain regulatory compliance with confidence.
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <div>
              ...
              <p className="text-xl text-gray-400 leading-relaxed">
                ManageEngine Log360 is an integrated SIEM and log management solution that collects and analyzes logs across on-prem, cloud, and network environments.
It helps detect security threats early, ensure compliance, and gain actionable IT insights.
            ...
            <div className="mt-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="space-y-4">
                  ...
                  <h4 className="text-xl font-semibold">Centralized Log Management </h4>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <h4 className="text-xl font-semibold">Threat Detection & Incident Response</h4>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-8 hover:border-green-500 transition space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-xl font-semibold">Centralized Log Management</h3>
              </div>
              <p className="text-gray-400">
                 Collect and store logs from all sources in a secure, searchable repository.
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-8 hover:border-green-500 transition space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-xl font-semibold">Real-Time Threat Detection
</h3>
              </div>
              <p className="text-gray-400">
                 Identify security anomalies and potential threats as they happen.
              </p>
            </div>
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-8 hover:border-green-500 transition space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-xl font-semibold"> Compliance and Audit Ready</h3>
              </div>
              <p className="text-gray-400">
                 Generate reports aligned with standards like GDPR, HIPAA, ISO, SOX, and PCI DSS.
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-8 hover:border-green-500 transition space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-xl font-semibold">Simplified Security Operations</h3>
              </div>
              <p className="text-gray-400">
                 Reduce manual monitoring with automated correlation, alerts, and dashboards.
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-8 hover:border-green-500 transition space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-xl font-semibold">
                  Advanced Security Analytics & Forensics

                </h3>
              </div>
              <p className="text-gray-400">
                 Analyze attack patterns, investigate incidents faster, and strengthen overall security posture.
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-8 hover:border-green-500 transition space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-xl font-semibold">
                  Scalable SIEM for Hybrid Environments

                </h3>
              </div>
              <p className="text-gray-400">
                Easily scale log monitoring across on-prem, cloud, and hybrid infrastructures as your organization grows.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start gap-3">
                  <span className="text-green-400 font-bold">•</span>
                  <span className="text-lg">User Behavior & Insider Threat Analysis</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-green-400 font-bold">•</span>
                  <span className="text-lg">
                ...
                <li className="flex items-start gap-3">
                  <span className="text-green-400 font-bold">•</span>
                  <span className="text-lg">Role-Based Access Control
</span>
                </li>
              </ul>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl lg:text-5xl font-bold text-center mb-12">
              Who Should Use ManageEngine Log360?
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-12 space-y-6">
              <div className="flex items-start gap-4">
                ...
                <p className="text-lg">
                  IT security teams monitoring on-premises and cloud environments
              ...
              <div className="flex items-start gap-4">
                <span className="text-green-400 text-2xl font-bold">✓</span>
                <p className="text-lg">
                  Enterprises needing real-time threat detection and response
              ...
              <div className="flex items-start gap-4">
                <span className="text-green-400 text-2xl font-bold">✓</span>
                <p className="text-lg">
                 Organizations maintaining regulatory compliance
                </p>
              </div>
              <div className="flex items-start gap-4">
                <span className="text-green-400 text-2xl font-bold">✓</span>
                <p className="text-lg">
                  Businesses analyzing user behavior and insider threats
              ...
              <div className="flex items-start gap-4">
                <span className="text-green-400 text-2xl font-bold">✓</span>
                <p className="text-lg">
                  Companies centralizing logs and security event management
      ...
      <section id="contact" className="py-20 bg-gradient-to-b from-black to-gray-950 border-t border-gray-800">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <div>
              <h2 className="text-4xl lg:text-5xl font-bold mb-6">
               Secure Your IT Environment with Log360

              </h2>
              <p className="text-xl text-gray-400 leading-relaxed">
                Detect threats, maintain compliance, and analyze IT logs effectively with ManageEngine Log360. Get expert guidance to implement a scalable, efficient, and security-focused SIEM and log management strategy tailored to your organization.
